...
public class Etudiant {
	 ...
	 */
	   ...
	   */
	    ...
	    * @param promo
	    */
	    public Etudiant(String nom, String prenom, String dateDeNaissance, int classement1A, String identifiant, String mdp,Promotion promo) {
	        this.nom = nom;
	        this.prenom = prenom;
	    ...
	    public Etudiant(String identifiant,String nom, String prenom,String mdp, String dateDeNaissance,int classement1A,String statut,String contrat,String entreprise,String mobilite, int choixfinal, int identifiantpromo) {
	    	this.identifiant= identifiant;
	    	this.nom= nom;
	    	this.prenom= prenom;
	    	this.mdp = mdp;
