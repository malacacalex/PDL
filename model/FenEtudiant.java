...
public class FenEtudiant extends Application {
	...
	private JPanel createAddPanel() {
	     ...
	     String[] colonnes = {"Dominante", "Choix 1","Choix 2","Choix 3","Choix 4 ","Choix 5", "Nb_place"};

	        //Lignes de notre tableau à choix
	        Object[][]donnees = {
	            {dom.get(0).getNom(), false,false,false,false,false,dom.get(0).getNbPlaces()},
	            {dom.get(1).getNom(), false,false,false,false,false,dom.get(1).getNbPlaces()},
	            {dom.get(2).getNom(), false,false,false,false,false,dom.get(2).getNbPlaces()},
	            {dom.get(3).getNom(), false,false,false,false,false,dom.get(3).getNbPlaces()},
	            {dom.get(4).getNom(), false,false,false,false,false,dom.get(4).getNbPlaces()},
	            {dom.get(5).getNom(), false,false,false,false,false,dom.get(5).getNbPlaces()},
	            {dom.get(6).getNom(), false,false,false,false,false,dom.get(6).getNbPlaces()},
	            {dom.get(7).getNom(), false,false,false,false,false,dom.get(7).getNbPlaces()},
	            {dom.get(8).getNom(), false,false,false,false,false,dom.get(8).getNbPlaces()},
	            {dom.get(9).getNom(), false,false,false,false,false,dom.get(9).getNbPlaces()},
	            {dom.get(10).getNom(), false,false,false,false,false,dom.get(10).getNbPlaces()},
	            {dom.get(11).getNom(), false,false,false,false,false,dom.get(11).getNbPlaces()},
	            {dom.get(12).getNom(), false,false,false,false,false,dom.get(12).getNbPlaces()},
